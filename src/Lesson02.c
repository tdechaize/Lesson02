...
*
* \file            Lesson02.c
* \author          Jeff Molofee ( NeHe ) originely, HUGE Thanks To Fredric Echols For Cleaning Up, and after adapted smoothly by Thierry Dechaize
* \version         2.0.1.0
* \date            3 février 2023
...
* \details    Aucun paramètre : GLvoid.
* \param 	  GLvoid			 nothing in OpenGL
...
* \return   Bool 			Un Booleen restituant le statut de la bonne création de la fenêtre OpenGL.
*
*/
